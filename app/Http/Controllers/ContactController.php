...
class ContactController extends Controller
{
    ...
    {
        $allContacts = Contact::orderBy('id', 'desc')->paginate(3);
    ...
    public function destroyAllSelectedRecord(Request $request)
    {
        ...
        $result = Contact::orderBy('id', 'desc')->paginate(3);
    ...
    public function search(Request $request)
    {
        ...
        $list = Contact::where('name', 'LIKE', '%' . $request->keywords . '%')->orderBy('id', 'desc')->get();
        $result = Contact::where('name', 'LIKE', '%' . $request->keywords . '%')->orderBy('id', 'desc')->paginate(3);
